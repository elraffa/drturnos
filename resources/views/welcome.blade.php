    ...
    <div class="bg-white">
        <header class="absolute inset-x-0 top-0 z-50">
            ...
            <div class="flex lg:flex-1">
                ...
                <span class="sr-only">MedTurnos</span>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Turnos fáciles para todo tipo de profesionales</h1>
